    ...
    <div className="max-w-360 w-full m-auto relative">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-6 mt-10">
          ...
          <Button
            text={"Contact Us"}
            className="hover:bg-green hover:text-white hover:border-transparent border-2 border-primary font-semibold text-base text-primary py-3 px-6 rounded-[200px]"
          />
        </div>
      </div>
    </div>
