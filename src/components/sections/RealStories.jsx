  ...
  return (
    <div className="max-w-285 m-auto w-full py-20 lg:py-42.5 px-4 lg:px-0">
      <div className="max-w-181 m-auto">
        <h2 className="font-bold text-3xl sm:text-4xl lg:text-custom-5xl text-primary leading-tight text-center lg:text-left">
          Real Stories. Real Funding.
        </h2>
        <p className="m-auto font-normal text-base leading-normal text-secondary max-w-147.5 text-center mt-3">
