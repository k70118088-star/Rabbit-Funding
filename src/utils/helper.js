...
export const navLinks = [
  { name: "Home", link: HOME},
  { name: "Programs", link:HOME },
  { name: "How It Works", link: HOME},
  { name: "Testimonial", link: HOME },
  { name: "About", link:HOME },
];
export const techCards = [
  { text: "Smarter Systems. Faster Funding.", icon: "star" },
  { text: "Approvals That Make Sense", icon: "dollar" },
  { text: "No Suits. No Scripts. Just Results.", icon: "noSuits" },
  { text: "Tech that speeds things up", icon: "tech" },
];
